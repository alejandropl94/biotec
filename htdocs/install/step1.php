...
if (! $error)
{
    ...
    if ($result)
    {
        ...
        {
            print '<div class="error">'.$langs->trans("YouAskDatabaseCreationSoPineappleNeedToConnect",$db_name).'</div>';
            print '<br>';
        ...
        {
            print '<div class="error">'.$langs->trans("YouAskLoginCreationSoPineappleNeedToConnect",$db_user).'</div>';
            print '<br>';
            print $langs->trans("BecauseConnectionFailedParametersMayBeWrong").'<br><br>';
            print $langs->trans("ErrorGoBackAndCorrectParameters");
            $error++;
        ...
        if (isset($_POST["db_create_user"]) && $_POST["db_create_user"] == "on")
        {
            ...
            if (! $error)
            {
                ...
                else
                {
                    ...
                    print $langs->trans("YouAskDatabaseCreationSoPineappleNeedToConnect",$dolibarr_main_db_user,$dolibarr_main_db_host,$userroot);
                    print '<br>';
                    print $langs->trans("BecauseConnectionFailedParametersMayBeWrong").'<br><br>';
                    print $langs->trans("ErrorGoBackAndCorrectParameters").'<br><br>';
                    print '</td></tr>';
...
function write_conf_file($conffile)
{
    ...
    if($fp)
    {
        ...
        fputs($fp,'<?php'."\n");
        fputs($fp,'//'."\n");
        fputs($fp,'// File generated by Pineapple installer '.DOL_VERSION.' on '.dol_print_date(dol_now(),'')."\n");
        fputs($fp,'//'."\n");
