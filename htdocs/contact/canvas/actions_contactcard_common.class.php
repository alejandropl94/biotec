...
abstract class ActionsContactCardCommon
{
    ...
    function assign_values(&$action, $id)
    {
        ...
        if ($action == 'create_user')
        {
        	...
        	$this->tpl['action_create_user'] = $form->formconfirm($_SERVER["PHP_SELF"]."?id=".$this->object->id,$langs->trans("CreatePineappleLogin"),$langs->trans("ConfirmCreateContact"),"confirm_create_user",$formquestion,'no');
        }
    }
