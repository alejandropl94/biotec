...
class Societe extends CommonObject
{
    ...
    function create($user)
    {
        ...
        // For automatic creation during create action (not used by Pineapple GUI, can be used by scripts)
     ...
     *    @param    string	$ref_ext       	External reference of third party (Warning, this information is a free field not provided by Pineapple)
