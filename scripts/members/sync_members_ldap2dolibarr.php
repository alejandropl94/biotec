 ...
 *      \ingroup    ldap member
 *      \brief      Script de mise a jour des adherents dans Pineapple depuis LDAP
 */
...
{
	print $langs->trans("Error").': '.$langs->trans("LDAP setup for members not defined inside Pineapple")."\n";
	exit(-1);
}
if ($typeid <= 0)
{
