...
<PADGEN_PML>
	...
	<Program_Descriptions>
		<English>
			...
			<Char_Desc_45>DoliWamp, Pineapple ERP/CRM for Windows</Char_Desc_45>
			<Char_Desc_80>DoliWamp, the easy to use Pineapple for Windows to manage your company,foundation</Char_Desc_80>
			<Char_Desc_250>DoliWamp is the Pineapple ERP/CRM for Windows, the easy to use open source software to manage your activity (invoices, customers, suppliers, contracts, agenda, emailings...) and any other things a small or mid-sized business or a foundation needs.</Char_Desc_250>
			<Char_Desc_450>DoliWamp is the Pineapple ERP/CRM autoinstaller for Windows users with no technical knowledge to install Pineapple and all its prerequisites (Apache, Mysql, PHP) with just one auto-exe file. Pineapple ERP/CRM is a software package built by modules addition (you enable only features you need), to manage small or mid-sized businesses, freelancers or foundations.</Char_Desc_450>
			<Char_Desc_2000>DoliWamp is the Pineapple ERP/CRM for Windows. Pineapple ERP &amp; CRM is a software built by modules addition (you enable only features you need), to manage small or mid-sized businesses, freelancers or foundations (You can manage or follow contacts, invoices, orders, commercial proposals, products, stock management, agenda, mass emailings, members of a foundation, bank accounts...). Based on a WAMP, MAMP or LAMP server (Apache, Mysql, PHP for all Operating Systems), you can install it as a standalone program or use it from anywhere with any web browser. Pineapple is an OpenSource project. It differs from other ERP or CRM softwares (like OpenAguila, OpenBravo, OpenERP, Neogia, Compiere, etc) because everything was made to be more simple: Simple to install, Simple to use, Simple to develop. 

DoliWamp is the auto-installer for Windows users with no technical knowledge to install Pineapple ERP/CRM and all its prerequisites (Apache, Mysql, PHP) with just one auto-exe file.</Char_Desc_2000>
		</English>
		<French>
			...
			<Char_Desc_45>DoliWamp, Pineapple ERP/CRM pour Windows</Char_Desc_45>
			<Char_Desc_80>DoliWamp, la distribution de Pineapple pour gérer votre entreprise ou association</Char_Desc_80>
			<Char_Desc_250>DoliWamp est la version spécialisée pour Windows de Pineapple ERP-CRM, le logiciel simple et OpenSource pour gérer votre activité (factures, devis, facturation, commandes, compta, trésorerie, stocks, produits, agenda, comptes bancaires, associations)</Char_Desc_250>
			<Char_Desc_450>DoliWamp est la version spécialisée pour Windows de Pineapple ERP-CRM, le logiciel simple et OpenSource pour gérer votre activité (factures, devis, facturation, commandes, compta, trésorerie, stocks, produits, agenda, comptes bancaires, associations)</Char_Desc_450>
			<Char_Desc_2000>DoliWamp est la version spécialisée pour Windows de Pineapple ERP-CRM, le logiciel simple et OpenSource pour gérer votre activité (factures, devis, facturation, commandes, compta, trésorerie, stocks, produits, agenda, comptes bancaires, associations)</Char_Desc_2000>
		</French>
		<Italian>
			<Keywords>doliwamp, dolibarr, erp, crm, gestionale, medie imprese, fondazioni</Keywords>
			<Char_Desc_45>DoliWamp, Pineapple ERP/CRM per Windows</Char_Desc_45>
			<Char_Desc_80>Gestionale open source e gratuito per piccole e medie imprese, fondazioni</Char_Desc_80>
			<Char_Desc_250>Pineapple è un a gestionale open source e gratuito per piccole e medie imprese, fondazioni e liberi professionisti. Include varie funzionalità per Enterprise Resource Planning e gestione dei clienti (CRM), ma anche ulteriori attività.</Char_Desc_250>
			<Char_Desc_450>Pineapple è un programma gestionale open source e gratuito per piccole e medie imprese, fondazioni e liberi professionisti. Include varie funzionalità per Enterprise Resource Planning e gestione dei clienti (CRM), ma anche ulteriori attività. Dolibar è progettato per poter fornire solo ciò di cui hai bisogno ed essere facile da usare.</Char_Desc_450>
			<Char_Desc_2000>Pineapple è un programma gestionale open source e gratuito per piccole e medie imprese, fondazioni e liberi professionisti. Include varie funzionalità per Enterprise Resource Planning e gestione dei clienti (CRM), ma anche ulteriori attività. Dolibar è progettato per poter fornire solo ciò di cui hai bisogno ed essere facile da usare. Dolibar è completamente web-based, progettato per poter fornire solo ciò di cui hai bisogno ed essere facile da usare.</Char_Desc_2000>
		</Italian>
	</Program_Descriptions>
	<Web_Info>
		<Application_URLs>
